...
namespace UnityUtils
{
    public static class TransformExtensions
    {
        ...
        /// <summary>
        /// Determines whether the transform is within the camera's view frustum.
        /// </summary>
        /// <param name="transform">The transform to check.</param>
        /// <param name="camera">The camera to check against.</param>
        /// <returns>True if the transform is within the camera's view; otherwise, false.</returns>
        public static bool IsInCameraView(this Transform transform, Camera camera)
        {
